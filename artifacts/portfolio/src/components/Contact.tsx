...
const socialLinks = [
  {
    label: "Email",
    href: "mailto:achuthparisha005@gmail.com",
    icon: (
      <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ),
    value: "achuthparisha005@gmail.com",
    color: "#00d4ff",
  },
  {
    label: "LinkedIn",
    ...
    value: "linkedin.com/in/achyuthparisha",
    color: "#7c3aed",
  },
  {
    label: "GitHub",
    href: "https://github.com/Achyuth69",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    value: "github.com/Achyuth69",
    color: "#f0abfc",
  },
  {
    label: "Phone",
    href: "tel:+919398291845",
    icon: (
      <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
      </svg>
    ),
    value: "+91 93982 91845",
    color: "#34d399",
  },
];
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              {socialLinks.map((link, i) => (
                <motion.a
                  ...
                  style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1rem 1.25rem", textDecoration: "none", color: "var(--text-primary)", transition: "all 0.3s ease", cursor: "none" }}
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.15), rgba(124,58,237,0.15))", border: "1px solid rgba(0,212,255,0.4)", color: "var(--neon-blue)", padding: "14px 28px", borderRadius: "8px", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.875rem", fontWeight: 600, cursor: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", width: "100%", transition: "box-shadow 0.3s ease" }}
