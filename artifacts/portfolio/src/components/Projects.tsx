...
const projects = [
  {
    id: 1,
    title: "Sahayak AI",
    description: "Multilingual AI assistant for teachers with lesson planning, worksheet generation, and voice interaction. Powered by LLM-driven content generation with multimodal inputs — text, image, and voice.",
  ...
  },
  {
    ...
    description: "Real-time multi-agent system for disaster response with dedicated planning, resource allocation, and communication agents. Implements orchestration, consensus decision-making, and resilient architecture with fallbacks & checkpoints.",
  ...
  },
  {
    ...
    description: "Production-ready AI research automation agent beyond basic RAG. Features intelligent query expansion, source credibility scoring, temporal relevance analysis, and semantic clustering for deep research synthesis.",
    tech: ["RAG", "LLMs", "Query Expansion", "Semantic Clustering", "Python", "Vector DB"],
    color: "#f0abfc",
    accentColor: "rgba(240,171,252,0.08)",
    borderColor: "rgba(240,171,252,0.2)",
    icon: "🔬",
    demo: null,
    github: "https://github.com/Achyuth69/AI-Agent-for-Research-Automation",
    featured: true,
  },
  {
    id: 4,
    title: "Hybrid Secure Payment System",
    description: "Secure inter-branch banking transaction system with AES-256 encryption, RSA-2048 digital signatures, SHA-256 blockchain logging, JWT auth, fraud detection, and replay attack prevention.",
...
function ProjectCard({ project, index }: { project: (typeof projects)[0]; index: number }) {
  ...
  return (
    <div
      ref={cardRef}
      className={`project-card glass-card fade-up visible`}
      style={{
        ...
        <div style={{ display: "flex", gap: "10px" }}>
          {project.demo ? (
            <a href={project.demo} target="_blank" rel="noopener noreferrer"
              className="neon-btn" style={{ borderColor: project.color, color: project.color, flex: 1, justifyContent: "center", fontSize: "0.8rem" }}>
          ...
          {project.github && (
            <a href={project.github} target="_blank" rel="noopener noreferrer"
              style={{ flex: 1, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "6px", background: "transparent", border: "1px solid rgba(255,255,255,0.1)", color: "var(--text-muted)", padding: "10px 16px", borderRadius: "8px", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.8rem", textDecoration: "none", transition: "border-color 0.3s, color 0.3s" }}
...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={ref as React.RefObject<HTMLElement>} className="section">
