...
const projects = [
  ...
  },
  {
    ...
    description:
      "Production-ready AI research automation agent beyond basic RAG. Features intelligent query expansion, source credibility scoring, temporal relevance analysis, and semantic clustering for deep research synthesis.",
  ...
  },
  {
    ...
    description:
      "Secure inter-branch banking transaction system with AES-256 encryption, RSA-2048 digital signatures, SHA-256 blockchain logging, JWT auth, fraud detection, and replay attack prevention. Blockchain-based tamper-proof workflow with real-time MITM attack simulation.",
